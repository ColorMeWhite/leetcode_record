...
class Solution {
    public int findMin(int[] nums) {
        //二分查找
        //同153题概念一样，同样是比较mid和right的大小，不过由于有相同的元素，所以有三种情况
        //若mid<right,说明mid+1到right不是最小值，使得right=mid
        //若mid>right,说明left到mid不是最小值，使得left=mid+1
        //若mid=right.无法判断最小值在哪边，但可以判断，right不是最小值，而且有mid作为备份所以，right--
